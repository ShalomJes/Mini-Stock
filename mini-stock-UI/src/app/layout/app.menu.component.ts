        ...
        this.model = [
            {
            ...
            },
                {
                 ...
                 items: [
                   ...
                   { label: 'Configuration', icon: 'pi pi-fw pi-check-square', routerLink: ['/stock/stock-configuration']},
                   { label: 'Stock Users', icon: 'pi pi-fw pi-check-square', routerLink: ['/stock/stock-users'] },
